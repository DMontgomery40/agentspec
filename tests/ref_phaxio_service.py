...
class PhaxioFaxService:
    ...
    def __init__(
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] __init__: --agentspec | print | asyncio")
    ...
    def is_configured(self) -> bool:
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] is_configured: --agentspec | bool | print")
    ...
    async def send_fax(self, to_number: str, pdf_url: str, job_id: str) -> Dict[str, Any]:
          ...
          ok
            deps:
              calls:
                ...
                - range
                - resp.json
                - self._map_status_str
                - self.is_configured
                - str
                - to_number.startswith
              imports:
                - asyncio
                - config.reload_settings
                - config.settings
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] send_fax: --agentspec | Exception | ValueError")
    ...
    async def get_fax_status(self, provider_sid: str) -> Dict[str, Any]:
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] get_fax_status: --agentspec | ValueError | client.get")
        if not self.is_configured():
            raise ValueError("Phaxio is not properly configured")
        auth = (self.api_key, self.api_secret)
    ...
    async def cancel_fax(self, provider_sid: str) -> bool:
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] cancel_fax: --agentspec | ValueError | client.post")
        if not self.is_configured():
            raise ValueError("Phaxio is not properly configured")
        auth = (self.api_key, self.api_secret)
        async with httpx.AsyncClient(timeout=15.0) as client:
    ...
    async def handle_status_callback(self, callback_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] handle_status_callback: --agentspec | callback_data.get | g")
        ...
        def g(key: str) -> Optional[str]:
            ...
            """
            print(f"[AGENTSPEC_CONTEXT] g: --agentspec | callback_data.get | print")
    ...
    def _map_status(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] _map_status: --agentspec | payload.get | print")
    ...
    def _map_status_str(status: str) -> str:
        ...
        """
        print(f"[AGENTSPEC_CONTEXT] _map_status_str: --agentspec | lower | mapping.get")
